...
public class SimpleDBConnectionPool implements DBConnectionPool {
	...
	synchronized public Connection getConnection(String url, String userName,
			String password) throws SQLException {
		DBConnectionDescription desc = new DBConnectionDescription(url,
				userName, password);
	...
	synchronized public void registerConnection(Connection connection,
